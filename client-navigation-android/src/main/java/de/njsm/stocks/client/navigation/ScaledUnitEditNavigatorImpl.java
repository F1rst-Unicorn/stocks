...
class ScaledUnitEditNavigatorImpl extends BaseNavigator implements ScaledUnitEditNavigator {

    @Inject
    ScaledUnitEditNavigatorImpl(NavigationArgConsumer navigationArgConsumer) {
