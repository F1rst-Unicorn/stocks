...
public class FoodItemTabsNavigatorImplTest extends NavigationTest {

    private FoodItemTabsNavigatorImpl uut;

    @Before
    public void setup() {
        uut = new FoodItemTabsNavigatorImpl(navigationArgConsumer);
    }
