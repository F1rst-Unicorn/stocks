...
public class UnitListNavigatorTest extends NavigationTest {
    ...
    public void editingUnitContentBindsCorrectly() {
        ...
        UnitTabsFragmentDirections.ActionNavFragmentUnitListToNavFragmentUnitEdit actual = navigationArgConsumer.getLastArgument(UnitTabsFragmentDirections.ActionNavFragmentUnitListToNavFragmentUnitEdit.class);
    ...
    public void addingUnitBindsCorrectly() {
        ...
        assertThat(actual.getActionId(), is(R.id.action_nav_fragment_unit_list_to_nav_fragment_unit_add));
    }
}
