...
package de.njsm.stocks.clientold.network.server;
...
public class ServerManager {
    ...
    public void addUser(User u) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.addUser(u.name);
        executeCommand(call);
    }

    public void removeUser(User u) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.removeUser(u.id, u.version);
        executeCommand(call);
    }
    ...
    public void removeDevice(UserDevice d) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.removeDevice(d.id, d.version);
        executeCommand(call);
    }
    ...
    public void addLocation(Location l) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.addLocation(l.name);
        executeCommand(call);
    }

    public void removeLocation(Location l, boolean cascade) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.removeLocation(l.id, l.version, cascade ? 1 : 0);
        executeCommand(call);
    }

    public void renameLocation(Location l, String newName) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.renameLocation(l.id, l.version, newName);
        executeCommand(call);
    }
    ...
    public void addFood(Food f) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.addFood(f.name);
        executeCommand(call);
    }

    public void removeFood(Food f) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.removeFood(f.id, f.version);
        executeCommand(call);
    }

    public void renameFood(Food f, String newName) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.renameFood(f.id, f.version, newName);
        executeCommand(call);
    }
    ...
    public void addItem(FoodItem f) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.addFoodItem(InstantSerialiser.FORMAT.format(f.eatByDate), f.storedIn, f.ofType);
        executeCommand(call);
    }

    public void removeItem(FoodItem f) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.removeFoodItem(f.id, f.version);
        executeCommand(call);
    }

    public void edit(FoodItem f, Instant eatBy, int newLoc) throws NetworkException {
        Call<de.njsm.stocks.clientold.network.server.Response> call = backend.editFoodItem(f.id, f.version, InstantSerialiser.FORMAT.format(eatBy), newLoc);
        executeCommand(call);
    }
    ...
    private void executeCommand(Call<de.njsm.stocks.clientold.network.server.Response> call) throws NetworkException {
        try {
            Response<de.njsm.stocks.clientold.network.server.Response> r = call.execute();
            handleResponse(r);
        } catch (IOException e) {
            throw new NetworkException("Error connecting to the server", e);
        }
    ...
    private <T extends de.njsm.stocks.clientold.network.server.Response> void handleResponse(Response<T> response) throws NetworkException {
    ...
    private NetworkException error(Response<? extends de.njsm.stocks.clientold.network.server.Response> r) {
        logResponse(r);
        de.njsm.stocks.clientold.network.server.Response response = r.body();
