...
public class DeviceCommandHandler extends AbstractCommandHandler {
    ...
    public DeviceCommandHandler(Configuration c, ScreenWriter writer, Selector selector, Refresher refresher) {
        super(writer);
        this.c = c;
        this.command = "dev";
        ...
        commandList.add(new DeviceAddCommandHandler(c, writer, selector, refresher));
        commandList.add(new DeviceListCommandHandler(c, writer));
        commandList.add(new DeviceRemoveCommandHandler(c, writer, selector, refresher));
