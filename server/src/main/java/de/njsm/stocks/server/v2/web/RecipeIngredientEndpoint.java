...
@Path("v2/recipeingredient")
public class RecipeIngredientEndpoint extends Endpoint implements Get<RecipeIngredientRecord, RecipeIngredient>, Delete<RecipeIngredientForDeletion, RecipeIngredient> {
    ...
    @Override
    public RecipeIngredientForDeletion wrapParameters(int id, int version) {
        return new RecipeIngredientForDeletion(id, version);
    }
}
