...
public class UserDeviceForInsertion implements Insertable<UserDeviceRecord, UserDevice> {
    ...
    @Override
    public InsertOnDuplicateStep<UserDeviceRecord> insertValue(InsertSetStep<UserDeviceRecord> insertInto, Principals principals) {
