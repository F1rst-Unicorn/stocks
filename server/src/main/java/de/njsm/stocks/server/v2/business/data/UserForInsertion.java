...
public class UserForInsertion implements Insertable<UserRecord, User> {
    ...
    @Override
    public InsertOnDuplicateStep<UserRecord> insertValue(InsertSetStep<UserRecord> insertInto, Principals principals) {
