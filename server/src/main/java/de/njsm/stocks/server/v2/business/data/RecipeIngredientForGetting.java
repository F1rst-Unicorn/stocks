...
public class RecipeIngredientForGetting extends VersionedData implements RecipeIngredient {
    ...
    public RecipeIngredientForGetting(int id, int version, int amount, int ingredient, int recipe, int unit) {
        super(id, version);
        this.amount = amount;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RecipeIngredientForGetting)) return false;
        if (!super.equals(o)) return false;
        RecipeIngredientForGetting that = (RecipeIngredientForGetting) o;
    ...
    public boolean isContainedIn(RecipeIngredient item) {
        return RecipeIngredient.super.isContainedIn(item) &&
