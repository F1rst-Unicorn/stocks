...
class InMemoryLocationConflictInteractorImpl implements LocationConflictInteractor {

    @Inject
    InMemoryLocationConflictInteractorImpl() {
    }

    @Override
    public Observable<LocationEditConflictData> getLocationEditConflict(long errorId) {
        return Observable.just(LocationEditConflictData.create(1, 42, 43,
