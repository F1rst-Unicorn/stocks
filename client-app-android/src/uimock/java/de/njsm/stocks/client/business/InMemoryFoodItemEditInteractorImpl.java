...
class InMemoryFoodItemEditInteractorImpl implements FoodItemEditInteractor {

    @Inject
    InMemoryFoodItemEditInteractorImpl() {
    }

    @Override
    public Observable<FoodItemEditFormData> getFormData(Id<FoodItem> food) {
        return Observable.just(FoodItemEditFormData.create(
                1,
