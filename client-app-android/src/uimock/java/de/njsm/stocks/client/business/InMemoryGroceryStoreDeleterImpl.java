...
class InMemoryGroceryStoreDeleterImpl implements EntityDeleter<GroceryChain> {

    private final BehaviorSubject<List<GroceryChainForListing>> data;

    @Inject
    InMemoryGroceryStoreDeleterImpl(GroceryChainsForListing groceryChainsForListing) {
