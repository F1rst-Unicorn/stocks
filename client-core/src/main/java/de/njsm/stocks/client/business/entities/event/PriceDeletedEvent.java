...
@AutoValue
public abstract class PriceDeletedEvent extends ActivityEvent {
    ...
    public static PriceDeletedEvent create(PriceEventFeedItem feedItem, Localiser localiser) {
        return new AutoValue_PriceDeletedEvent(
    ...
    public <I, O> O accept(Visitor<I, O> visitor, I input) {
        return visitor.priceDeleted(this, input);
    }
}
