...
public interface BusinessModule {
    ...
    @Binds
    GroceryChainConflictInteractor GroceryChainConflictInteractor(GroceryChainConflictInteractorImpl impl);
    ...
    @Binds
    PriceShowInteractor PriceShowInteractor(PriceShowInteractorImpl impl);
}
