...
@AutoValue
public abstract class GroceryStoreEditConflictData {

    public abstract IdImpl<GroceryStore> id();
    ...
    public static GroceryStoreEditConflictData create(
            int errorId,
            IdImpl<GroceryStore> id,
            int remoteVersion,
            String originalName,
            String remoteName,
            String localName) {
        return new AutoValue_GroceryStoreEditConflictData(id, errorId, remoteVersion,
