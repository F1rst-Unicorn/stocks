...
@AutoValue
public abstract class FoodItemCreatedEvent extends ActivityEvent {
    ...
    public static FoodItemCreatedEvent create(FoodItemEventFeedItem feedItem, Localiser localiser) {
        return new AutoValue_FoodItemCreatedEvent(
