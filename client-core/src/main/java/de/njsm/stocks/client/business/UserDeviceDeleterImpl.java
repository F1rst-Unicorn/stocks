...
class UserDeviceDeleterImpl extends AbstractDeleterImpl<UserDevice> {

    @Inject
    UserDeviceDeleterImpl(
            EntityDeleteService<UserDevice> deleteService,
            EntityDeleteRepository<UserDevice> deleteRepository,
    ...
    @Override
    void recordError(SubsystemException e, Versionable<UserDevice> data) {
