...
class FoodDeleterImpl extends AbstractDeleterImpl<Food> {

    @Inject
    FoodDeleterImpl(EntityDeleteService<Food> deleteService,
                    EntityDeleteRepository<Food> deleteRepository,
    ...
    @Override
    void recordError(SubsystemException e, Versionable<Food> data) {
