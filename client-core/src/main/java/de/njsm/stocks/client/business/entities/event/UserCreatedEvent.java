...
@AutoValue
public abstract class UserCreatedEvent extends ActivityEvent {

    public abstract Id<User> id();

    public abstract String name();

    public static UserCreatedEvent create(UserEventFeedItem feedItem, Localiser localiser) {
        return new AutoValue_UserCreatedEvent(
    ...
    public <I, O> O accept(Visitor<I, O> visitor, I input) {
        return visitor.userCreated(this, input);
    }
}
