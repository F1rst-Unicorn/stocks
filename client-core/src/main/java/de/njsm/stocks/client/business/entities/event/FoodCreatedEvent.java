...
@AutoValue
public abstract class FoodCreatedEvent extends ActivityEvent {
    ...
    public static FoodCreatedEvent create(FoodEventFeedItem feedItem, Localiser localiser) {
        return new AutoValue_FoodCreatedEvent(
                localiser.toLocalDateTime(feedItem.transactionTimeStart()),
                feedItem.userName(),
                feedItem.id(),
                feedItem.name(),
                feedItem.toBuy(),
                feedItem.expirationOffset(),
                UnitAmount.of(feedItem.unitScale(), feedItem.abbreviation()),
                Optional.ofNullable(feedItem.locationName()),
                feedItem.description());
    }

    @Override
    public <I, O> O accept(Visitor<I, O> visitor, I input) {
        return visitor.foodCreated(this, input);
    }
}
