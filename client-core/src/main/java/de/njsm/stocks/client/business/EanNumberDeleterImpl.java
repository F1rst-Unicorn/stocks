...
class EanNumberDeleterImpl extends AbstractDeleterImpl<EanNumber> {

    @Inject
    EanNumberDeleterImpl(
            EntityDeleteService<EanNumber> deleteService,
            EntityDeleteRepository<EanNumber> deleteRepository,
    ...
    @Override
    void recordError(SubsystemException e, Versionable<EanNumber> data) {
