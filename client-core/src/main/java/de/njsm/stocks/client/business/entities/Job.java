...
public abstract class Job {
    ...
    public enum Type {
        ...
        COOK_RECIPE {
            @Override
            public <I, O> O accept(TypeVisitor<I, O> visitor, I input) {
                return visitor.cookRecipe(this, input);
            }
        },
        ...
        ADD_GROCERY_CHAIN {
            @Override
            public <I, O> O accept(TypeVisitor<I, O> visitor, I input) {
                return visitor.addGroceryChain(this, input);
            }
        },
        ...
        EDIT_GROCERY_CHAIN {
            @Override
            public <I, O> O accept(TypeVisitor<I, O> visitor, I input) {
                return visitor.editGroceryChain(this, input);
            }
        },
        ...
        DELETE_PRICE {
            @Override
            public <I, O> O accept(TypeVisitor<I, O> visitor, I input) {
                return visitor.deletePrice(this, input);
            }
        };
    ...
    public interface TypeVisitor<I, O> {
        ...
        O addUser(Type type, I input);

        O addUserDevice(Type type, I input);

        O deleteRecipe(Type type, I input);

        O editRecipe(Type type, I input);

        O cookRecipe(Type type, I input);

        O addGroceryChain(Type type, I input);

        O addGroceryStore(Type type, I input);

        O addPrice(Type type, I input);
        ...
        O deletePrice(Type type, I input);
    }
    ...
    public interface DefaultTypeVisitor<I, O> extends TypeVisitor<I, O> {
        ...
        @Override
        default O addUser(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O addUserDevice(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O deleteRecipe(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O editRecipe(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O cookRecipe(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O addGroceryChain(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O addGroceryStore(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O addPrice(Type type, I input) {
            return defaultImpl(type, input);
        }

        @Override
        default O editGroceryChain(Type type, I input) {
            return defaultImpl(type, input);
        }
        ...
        @Override
        default O deletePrice(Type type, I input) {
            return defaultImpl(type, input);
        }
    }
}
