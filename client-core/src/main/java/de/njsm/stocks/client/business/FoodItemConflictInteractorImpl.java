...
class FoodItemConflictInteractorImpl implements FoodItemConflictInteractor {
    ...
    @Inject
    FoodItemConflictInteractorImpl(FoodItemEditRepository repository, ConflictRepository conflictRepository) {
