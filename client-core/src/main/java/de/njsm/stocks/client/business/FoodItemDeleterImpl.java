...
class FoodItemDeleterImpl extends AbstractDeleterImpl<FoodItem> {

    @Inject
    FoodItemDeleterImpl(
            EntityDeleteService<FoodItem> deleteService,
            EntityDeleteRepository<FoodItem> deleteRepository,
    ...
    @Override
    void recordError(SubsystemException e, Versionable<FoodItem> data) {
