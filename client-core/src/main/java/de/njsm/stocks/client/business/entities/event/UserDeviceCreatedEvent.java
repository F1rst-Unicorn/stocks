...
@AutoValue
public abstract class UserDeviceCreatedEvent extends ActivityEvent {
    ...
    public static UserDeviceCreatedEvent create(UserDeviceEventFeedItem feedItem, Localiser localiser) {
        return new AutoValue_UserDeviceCreatedEvent(
    ...
    public <I, O> O accept(Visitor<I, O> visitor, I input) {
        return visitor.userDeviceCreated(this, input);
    }
}
