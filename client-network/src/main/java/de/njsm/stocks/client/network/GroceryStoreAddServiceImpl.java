...
import de.njsm.stocks.common.api.GroceryStoreForInsertion;
import retrofit2.Call;

import javax.inject.Inject;

class GroceryStoreAddServiceImpl extends ServiceQuery<GroceryStoreAddForm, GroceryStore> implements GroceryStoreAddService {

    @Inject
    GroceryStoreAddServiceImpl(ServerApi api, CallHandler callHandler) {
        super(api, callHandler);
    }

    @Override
    public IdImpl<GroceryStore> addGroceryStore(GroceryStoreAddForm form) {
