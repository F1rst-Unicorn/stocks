...
public class EanNumberDeleteServiceImpl extends ServiceCommand<Versionable<EanNumber>> implements EntityDeleteService<EanNumber> {
    ...
    @Override
    Call<Response> buildCall(Versionable<EanNumber> entityForDeletion) {
        return api.deleteEanNumber(entityForDeletion.id(), entityForDeletion.version());
    }

    @Override
    public void delete(Versionable<EanNumber> entityForDeletion) {
