...
public class FoodItemDeleteServiceImpl extends ServiceCommand<Versionable<FoodItem>> implements EntityDeleteService<FoodItem> {
    ...
    @Override
    Call<Response> buildCall(Versionable<FoodItem> entityForDeletion) {
        return api.deleteFoodItem(entityForDeletion.id(), entityForDeletion.version());
    }

    @Override
    public void delete(Versionable<FoodItem> entityForDeletion) {
