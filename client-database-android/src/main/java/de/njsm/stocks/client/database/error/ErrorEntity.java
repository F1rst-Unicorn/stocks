...
public abstract class ErrorEntity implements IdFields {
    ...
    interface ActionVisitor<I, O> {
        ...
        O deleteGroceryChain(Action action, I input);

        O deleteGroceryStore(Action action, I input);

        O deletePrice(Action action, I input);
        ...
        O editGroceryChain(Action action, I input);

        O editGroceryStore(Action action, I input);
    }
