...
class DataDeleter implements ErrorEntity.ActionVisitor<Long, Void> {
    ...
    @Override
    public Void deleteRecipe(ErrorEntity.Action action, Long input) {
        errorDao.deleteRecipeToAdd(input);
        return null;
    }

    @Override
    public Void editRecipe(ErrorEntity.Action action, Long input) {
        errorDao.deleteRecipeEdit(input);
        errorDao.deleteRecipeIngredientEdit(input);
        errorDao.deleteRecipeProductEdit(input);
        return null;
    }

    @Override
    public Void deleteGroceryChain(ErrorEntity.Action action, Long input) {
        errorDao.deleteGroceryChainDelete(input);
        return null;
    }

    @Override
    public Void deleteGroceryStore(ErrorEntity.Action action, Long input) {
        errorDao.deleteGroceryStoreDelete(input);
        return null;
    }

    @Override
    public Void deletePrice(ErrorEntity.Action action, Long input) {
        errorDao.deletePriceDelete(input);
        return null;
    }

    @Override
    public Void addGroceryChain(ErrorEntity.Action action, Long input) {
        errorDao.deleteGroceryChainAdd(input);
        return null;
    }

    @Override
    public Void addGroceryStore(ErrorEntity.Action action, Long input) {
    ...
    @Override
    public Void editGroceryChain(ErrorEntity.Action action, Long input) {
        errorDao.deleteGroceryChainEdit(input);
        return null;
    }

    @Override
    public Void editGroceryStore(ErrorEntity.Action action, Long input) {
        errorDao.deleteGroceryStoreEdit(input);
        return null;
    }
}
