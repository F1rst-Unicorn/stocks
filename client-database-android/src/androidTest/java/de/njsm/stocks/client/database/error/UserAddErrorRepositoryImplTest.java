...
public class UserAddErrorRepositoryImplTest extends AbstractErrorRepositoryImplTest {

    ErrorDetails recordError(StatusCodeException e) {
        UserAddForm form = UserAddForm.create("Joanna");
    ...
    List<?> getErrorDetails() {
        return stocksDatabase.errorDao().getUserAdds();
    }
}
