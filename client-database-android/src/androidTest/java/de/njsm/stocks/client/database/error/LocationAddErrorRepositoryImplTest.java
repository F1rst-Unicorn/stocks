...
public class LocationAddErrorRepositoryImplTest extends AbstractErrorRepositoryImplTest {

    ErrorDetails recordError(StatusCodeException e) {
        LocationAddForm form = LocationAddForm.create("Fridge", "the cold one");
        errorRecorder.recordLocationAddError(e, form);
        return form;
    }

    @Override
    List<?> getErrorDetails() {
        return stocksDatabase.errorDao().getLocationAdds();
    }
}
