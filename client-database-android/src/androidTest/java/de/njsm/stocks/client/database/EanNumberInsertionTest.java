...
public class EanNumberInsertionTest extends InsertionTest<EanNumberDbEntity, EanNumberDbEntity.Builder> {
    ...
    @Override
    List<EanNumberDbEntity> getAll() {
        return stocksDatabase.eanNumberDao().getAll();
    }

    @Override
    void insert(List<EanNumberDbEntity> data, SynchronisationDao synchronisationDao) {
        synchronisationDao.writeEanNumbers(data);
    }

    @Override
    void synchronise(List<EanNumberDbEntity> data, SynchronisationDao synchronisationDao) {
        synchronisationDao.synchroniseEanNumbers(data);
    }
}
