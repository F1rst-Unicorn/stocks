...
public class FoodAmountAdapter extends RecyclerView.Adapter<FoodAmountViewHolder> {
    ...
    private List<FoodWithAmountForListing> foods;
    ...
    public void setData(List<FoodWithAmountForListing> newList) {
        List<FoodWithAmountForListing> oldList = foods;
        foods = newList;
    ...
    public void onBindViewHolder(@NonNull FoodAmountViewHolder holder, int position) {
        FoodWithAmountForListing item = foods.get(position);
        holder.setName(item.name());
        holder.setToBuy(false);
