...
public class GroceryChainForm {
    ...
    public GroceryChainForm(View root, Function<Integer, String> dictionary) {
        this.nameField = new ConflictTextField(root.findViewById(R.id.fragment_grocery_chain_form_name));
