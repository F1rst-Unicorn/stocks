...
package de.njsm.stocks.client.fragment.grocerychainadd;
...
import de.njsm.stocks.client.presenter.GroceryChainAddViewModel;
...
public class GroceryChainAddFragment extends BottomToolbarFragment {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        GroceryChainAddForm data = GroceryChainAddForm.create(form.getName());
        groceryChainAddViewModel.addGroceryChain(data);
        navigator.back();
        return true;
    }
    ...
    protected void setViewModelFactory(ViewModelProvider.Factory viewModelFactory) {
        ...
        groceryChainAddViewModel = viewModelProvider.get(GroceryChainAddViewModel.class);
    }
