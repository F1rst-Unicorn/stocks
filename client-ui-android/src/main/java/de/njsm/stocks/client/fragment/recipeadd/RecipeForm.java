...
class RecipeForm {
    ...
    public void setIngredients(RecipeIngredientFoodAdapter ingredientAdapter) {

    }

    public void setProducts(RecipeProductFoodAdapter productAdapter) {
