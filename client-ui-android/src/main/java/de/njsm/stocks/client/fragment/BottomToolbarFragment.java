...
import de.njsm.stocks.client.fragment.view.BottomToolbar;
...
public class BottomToolbarFragment extends InjectableFragment {
    ...
    protected View insertContent(@NonNull LayoutInflater inflater, View root, @LayoutRes int contentLayout) {
