...
public class GroceryStoreAdapter extends RecyclerView.Adapter<TextWithPrefixIconViewHolder> {

    private List<GroceryStoreForListing> groceryStores;

    private final View.OnClickListener onClickListener;

    private final View.OnLongClickListener onLongClickListener;

    public GroceryStoreAdapter(View.OnClickListener onClickListener, View.OnLongClickListener onLongClickListener) {
        this.onClickListener = onClickListener;
        this.onLongClickListener = onLongClickListener;
    }

    public void setData(List<GroceryStoreForListing> newList) {
        List<GroceryStoreForListing> oldList = groceryStores;
        groceryStores = newList;
    ...
    public void onBindViewHolder(@NonNull TextWithPrefixIconViewHolder holder, int position) {
        GroceryStoreForListing item = groceryStores.get(position);
