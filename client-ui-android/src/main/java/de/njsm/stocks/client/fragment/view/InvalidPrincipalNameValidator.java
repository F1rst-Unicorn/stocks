...
public class InvalidPrincipalNameValidator implements TextWatcher {

    private final TextInputLayout view;

    private final BiConsumer<TextInputLayout, Boolean> errorTextResourceSetter;

    public InvalidPrincipalNameValidator(TextInputLayout v, BiConsumer<TextInputLayout, Boolean> errorTextResourceSetter) {
