...
public class DataIconSelector implements Visitor<Void, Integer> {
    ...
    public Integer foodItemCreated(FoodItemCreatedEvent foodItemCreatedEvent, Void input) {
        return R.drawable.baseline_room_service_black_24;
    }
    ...
    public Integer scaledUnitCreated(ScaledUnitCreatedEvent scaledUnitCreatedEvent, Void input) {
        return R.drawable.ic_weight_numbered_black_24;
    }
    ...
    public Integer unitCreated(UnitCreatedEvent unitCreatedEvent, Void input) {
        return R.drawable.ic_weight_black_24;
    }
    ...
    @Override
    public Integer groceryStoreCreated(GroceryStoreCreatedEvent groceryStoreCreatedEvent, Void input) {
        return R.drawable.ic_store_black_24dp;
    }

    @Override
    public Integer groceryStoreDeleted(GroceryStoreDeletedEvent groceryStoreDeletedEvent, Void input) {
        return R.drawable.ic_store_black_24dp;
    }

    @Override
    public Integer groceryStoreEdited(GroceryStoreEditedEvent groceryStoreEditedEvent, Void input) {
        return R.drawable.ic_store_black_24dp;
    }

    @Override
    public Integer priceCreated(PriceCreatedEvent priceCreatedEvent, Void input) {
        return R.drawable.baseline_money_black_24;
    }

    @Override
    public Integer priceDeleted(PriceDeletedEvent priceDeletedEvent, Void input) {
        return R.drawable.baseline_money_black_24;
    }
}
