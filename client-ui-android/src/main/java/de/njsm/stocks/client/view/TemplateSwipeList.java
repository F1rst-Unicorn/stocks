...
class TemplateSwipeList {
    ...
    void setEmpty(@StringRes int emptyHint) {
        list.setVisibility(View.GONE);
    ...
    <T extends RecyclerView.ViewHolder> void initialiseListWithSwiper(Context context, RecyclerView.Adapter<T> adapter, ItemTouchHelper.SimpleCallback swipeCallback) {
