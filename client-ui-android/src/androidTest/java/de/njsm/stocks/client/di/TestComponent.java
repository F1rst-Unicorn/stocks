...
import de.njsm.stocks.client.fragment.fooditemadd.FoodItemAddFragmentEmptyLocationsTest;
...
import de.njsm.stocks.client.fragment.searchedfood.SearchedFoodFragmentTest;
...
import de.njsm.stocks.client.fragment.ticketshow.TicketShowFragmentTest;
...
import de.njsm.stocks.client.fragment.useradd.UserAddFragmentTest;
import de.njsm.stocks.client.fragment.userdeviceadd.UserDeviceAddFragmentTest;
...
public interface TestComponent {
    ...
    void inject(RecipeListFragmentTest test);

    void inject(EanNumberListFragmentTest test);
    ...
    void inject(RecipeDetailFragmentTest test);

    void inject(UserAddFragmentTest test);

    void inject(UserDeviceAddFragmentTest test);

    void inject(TicketShowFragmentTest test);
