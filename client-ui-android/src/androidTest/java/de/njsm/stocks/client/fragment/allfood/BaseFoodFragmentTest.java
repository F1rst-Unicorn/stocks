...
public abstract class BaseFoodFragmentTest {
    ...
    protected abstract void setData(List<FoodForListing> data);
    ...
    public void emptyListShowsText() {
        ...
        onView(withId(R.id.template_swipe_list_empty_text))
                .check(matches(allOf(withEffectiveVisibility(Visibility.VISIBLE), withText(getEmptyText()))));
    }

    @Test
    public void foodIsListed() {
        setData(FoodsForListing.get());
