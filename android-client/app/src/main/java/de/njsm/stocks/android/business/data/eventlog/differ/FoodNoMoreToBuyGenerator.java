...
public class FoodNoMoreToBuyGenerator extends PartialDiffGenerator<FoodWithLocationName> {

    public FoodNoMoreToBuyGenerator(IntFunction<String> stringResourceResolver, FoodWithLocationName oldEntity, FoodWithLocationName newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return getOldEntity().toBuy && !getNewEntity().toBuy;
    }
    ...
    protected Object[] getFormatArguments() {
        return new Object[] { getObject().get() };
    }
}
