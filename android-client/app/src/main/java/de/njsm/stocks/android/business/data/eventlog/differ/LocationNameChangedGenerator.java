...
public class LocationNameChangedGenerator extends PartialDiffGenerator<Location> {

    public LocationNameChangedGenerator(IntFunction<String> stringResourceResolver, Location oldEntity, Location newEntity, SentenceObject object) {
