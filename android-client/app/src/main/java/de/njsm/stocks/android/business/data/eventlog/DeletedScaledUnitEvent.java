...
public class DeletedScaledUnitEvent extends DeletedEntityEvent<ScaledUnitView> implements ScaledUnitIconResourceProvider {

    public DeletedScaledUnitEvent(User initiatorUser, UserDevice initiatorUserDevice, ScaledUnitView unit) {
    ...
    public <I, O> O accept(EventVisitor<I, O> visitor, I arg) {
        return visitor.deletedScaledUnitEvent(arg);
    }
}
