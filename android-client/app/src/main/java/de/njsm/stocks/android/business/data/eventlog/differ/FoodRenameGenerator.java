...
public class FoodRenameGenerator extends PartialDiffGenerator<FoodWithLocationName> {

    public FoodRenameGenerator(IntFunction<String> stringResourceResolver, FoodWithLocationName oldEntity, FoodWithLocationName newEntity, SentenceObject object) {
