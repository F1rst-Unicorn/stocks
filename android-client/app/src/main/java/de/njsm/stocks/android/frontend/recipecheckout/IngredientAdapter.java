...
public class IngredientAdapter extends Adapter {
    ...
    public IngredientAdapter(ResourceProvider resourceProvider, LiveData<List<RecipeFoodCheckout>> data, Consumer<View> onClickListener, Consumer<FoodForSetToBuy> shoppingCartCallback) {
        super(resourceProvider, data, onClickListener, shoppingCartCallback);
    }

    @Override
    AmountsAdapter buildAdapter() {
        return new AmountsWithStockAdapter();
    }
}
