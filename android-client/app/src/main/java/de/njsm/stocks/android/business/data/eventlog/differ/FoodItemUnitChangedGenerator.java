...
public class FoodItemUnitChangedGenerator extends PartialDiffGenerator<FoodItemViewWithFood> {

    public FoodItemUnitChangedGenerator(IntFunction<String> stringResourceResolver, FoodItemViewWithFood oldEntity, FoodItemViewWithFood newEntity, SentenceObject object) {
    ...
    protected Object[] getFormatArguments() {
        return new Object[] {
                ...
                ScaledUnitView.getPrettyName(getOldEntity().getScaledUnit(), getOldEntity().getUnitEntity()),
                ScaledUnitView.getPrettyName(getNewEntity().getScaledUnit(), getNewEntity().getUnitEntity()),
        };
    }
}
