...
public class DeletedFoodItemEvent extends DeletedEntityEvent<FoodItemViewWithFood> implements FoodItemIconResourceProvider {

    public DeletedFoodItemEvent(User initiatorUser, UserDevice initiatorDevice, FoodItemViewWithFood entity) {
    ...
    public String describe(IntFunction<String> stringResourceResolver) {
        ...
        return String.format(template, initiatorUser.name, entity.getFood().getName());
    }
