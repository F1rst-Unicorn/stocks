...
public class SettingsUpdaterViewModel extends ViewModel {

    private HostnameInterceptor interceptor;

    @Inject
    public SettingsUpdaterViewModel(HostnameInterceptor interceptor) {
