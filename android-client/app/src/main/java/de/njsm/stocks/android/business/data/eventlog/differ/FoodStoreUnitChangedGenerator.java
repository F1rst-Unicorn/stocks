...
public class FoodStoreUnitChangedGenerator extends PartialDiffGenerator<FoodWithLocationName> {

    public FoodStoreUnitChangedGenerator(IntFunction<String> stringResourceResolver, FoodWithLocationName oldEntity, FoodWithLocationName newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return getOldEntity().storeUnit != getNewEntity().storeUnit;
    }
