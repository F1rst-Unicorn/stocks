...
public class RecipeIngredientRepository {
    ...
    public LiveData<List<RecipeItemWithCurrentStock>> getIngredientViewsOf(int recipeId) {
        return Transformations.map(recipeIngredientDao.getIngredientViewsOf(recipeId),
