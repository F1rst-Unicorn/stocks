...
public class FoodExpirationOffsetChangedGenerator extends PartialDiffGenerator<FoodWithLocationName> {

    public FoodExpirationOffsetChangedGenerator(IntFunction<String> stringResourceResolver, FoodWithLocationName oldEntity, FoodWithLocationName newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return getOldEntity().expirationOffset != getNewEntity().expirationOffset;
    }
