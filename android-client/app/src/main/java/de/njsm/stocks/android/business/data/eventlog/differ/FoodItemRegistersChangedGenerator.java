...
public class FoodItemRegistersChangedGenerator extends PartialDiffGenerator<FoodItemViewWithFood> {

    public FoodItemRegistersChangedGenerator(IntFunction<String> stringResourceResolver, FoodItemViewWithFood oldEntity, FoodItemViewWithFood newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return getOldEntity().getRegisters() != getNewEntity().getRegisters();
    }
