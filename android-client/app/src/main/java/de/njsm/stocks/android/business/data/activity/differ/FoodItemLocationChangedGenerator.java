...
public class FoodItemLocationChangedGenerator extends PartialDiffGenerator<FoodItemWithFoodNameView> {

    public FoodItemLocationChangedGenerator(IntFunction<String> stringResourceResolver, FoodItemWithFoodNameView oldEntity, FoodItemWithFoodNameView newEntity, SentenceObject object) {
    ...
    protected Object[] getFormatArguments() {
        return new Object[] {
                getObject().get(),
                getOldEntity().getLocation(),
                getNewEntity().getLocation()
        };
    }
}
