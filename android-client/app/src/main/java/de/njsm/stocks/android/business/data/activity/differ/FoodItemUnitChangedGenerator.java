...
public class FoodItemUnitChangedGenerator extends PartialDiffGenerator<FoodItemWithFoodNameView> {

    public FoodItemUnitChangedGenerator(IntFunction<String> stringResourceResolver, FoodItemWithFoodNameView oldEntity, FoodItemWithFoodNameView newEntity, SentenceObject object) {
    ...
    protected Object[] getFormatArguments() {
        return new Object[] {
                ...
                getOldEntity().getScale(),
                getOldEntity().getUnitAbbreviation(),
                getNewEntity().getScale(),
                getNewEntity().getUnitAbbreviation(),
        };
    }
}
