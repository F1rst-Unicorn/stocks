...
public class DeletedEanNumberEvent extends DeletedEntityEvent<EanNumber> implements EanNumberIconResourceProvider {

    public DeletedEanNumberEvent(EanNumber entity) {
        super(entity);
    }
