...
public class FoodItemBuysChangedGenerator extends PartialDiffGenerator<FoodItemViewWithFood> {

    public FoodItemBuysChangedGenerator(IntFunction<String> stringResourceResolver, FoodItemViewWithFood oldEntity, FoodItemViewWithFood newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return getOldEntity().getBuys() != getNewEntity().getBuys();
    }
