...
public class ScaledUnitScaleDiffer extends PartialDiffGenerator<ScaledUnitView> {

    public ScaledUnitScaleDiffer(IntFunction<String> stringResourceResolver, ScaledUnitView oldEntity, ScaledUnitView newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return !getOldEntity().getScale().equals(getNewEntity().getScale());
    }
