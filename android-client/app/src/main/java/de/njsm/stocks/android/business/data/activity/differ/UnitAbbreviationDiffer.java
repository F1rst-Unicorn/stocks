...
public class UnitAbbreviationDiffer extends PartialDiffGenerator<Unit> {

    public UnitAbbreviationDiffer(IntFunction<String> stringResourceResolver, Unit oldEntity, Unit newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return !getOldEntity().getAbbreviation().equals(getNewEntity().getAbbreviation());
    }
    ...
    protected Object[] getFormatArguments() {
        return new Object[] {
                ...
                getOldEntity().getAbbreviation(),
                getNewEntity().getAbbreviation(),
        };
    }
}
