...
import de.njsm.stocks.android.frontend.editfood.FoodConflictFragment;
import de.njsm.stocks.android.frontend.editfood.FoodEditFragment;
import de.njsm.stocks.android.frontend.editlocation.LocationEditDescriptionFragment;
...
import de.njsm.stocks.android.frontend.fooditem.FoodDescriptionFragment;
import de.njsm.stocks.android.frontend.fooditem.FoodItemFragment;
import de.njsm.stocks.android.frontend.fooditem.FoodItemListFragment;
...
import de.njsm.stocks.android.frontend.recipecheckout.RecipeCheckoutFragment;
import de.njsm.stocks.android.frontend.recipedetail.RecipeFragment;
...
public abstract class ActivityModule {
    ...
    @ContributesAndroidInjector
    abstract FoodItemListFragment contributeFoodItemListFragment();

    @ContributesAndroidInjector
    abstract FoodDescriptionFragment contributeFoodItemDescriptionFragment();

    @ContributesAndroidInjector
    abstract FoodEditFragment contributeFoodEditFragment();

    @ContributesAndroidInjector
    abstract FoodConflictFragment contributeFoodConflictFragment();

    @ContributesAndroidInjector
    abstract LocationEditDescriptionFragment contributeLocationEditDescriptionFragment();

    @ContributesAndroidInjector
    abstract UnitFragment contributeUnitFragment();

    @ContributesAndroidInjector
    abstract UnitPagingFragment contributeUnitPagingFragment();
    ...
    @ContributesAndroidInjector
    abstract RecipeCheckoutFragment contributeRecipeCheckoutFragment();
