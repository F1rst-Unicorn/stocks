...
public class FoodDefaultLocationUnsetGenerator extends PartialDiffGenerator<FoodWithLocationName> {

    public FoodDefaultLocationUnsetGenerator(IntFunction<String> stringResourceResolver, FoodWithLocationName oldEntity, FoodWithLocationName newEntity, SentenceObject object) {
        super(stringResourceResolver, oldEntity, newEntity, object);
    }

    @Override
    protected boolean entitiesDiffer() {
        return getOldEntity().location != 0 && getNewEntity().location == 0;
    }
