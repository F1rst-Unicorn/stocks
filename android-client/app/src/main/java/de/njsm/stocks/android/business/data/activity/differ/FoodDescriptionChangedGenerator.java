...
public class FoodDescriptionChangedGenerator extends PartialDiffGenerator<FoodWithLocationName> {

    public FoodDescriptionChangedGenerator(IntFunction<String> stringResourceResolver, FoodWithLocationName oldEntity, FoodWithLocationName newEntity, SentenceObject object) {
