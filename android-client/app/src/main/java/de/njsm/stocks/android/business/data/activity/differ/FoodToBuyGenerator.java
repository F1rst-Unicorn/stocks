...
public class FoodToBuyGenerator extends PartialDiffGenerator<FoodWithLocationName> {

    public FoodToBuyGenerator(IntFunction<String> stringResourceResolver, FoodWithLocationName oldEntity, FoodWithLocationName newEntity, SentenceObject object) {
