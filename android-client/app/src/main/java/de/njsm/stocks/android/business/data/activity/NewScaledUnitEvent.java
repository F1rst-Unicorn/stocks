...
public class NewScaledUnitEvent extends NewEntityEvent<ScaledUnitView> implements ScaledUnitIconResourceProvider {

    public NewScaledUnitEvent(User initiatorUser, UserDevice initiatorUserDevice, ScaledUnitView unit) {
    ...
    public <I, O> O accept(EventVisitor<I, O> visitor, I arg) {
        return visitor.newScaledUnitEvent(arg);
    }
}
