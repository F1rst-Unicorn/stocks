...
public class DeleteFoodTask extends AbstractNetworkTask<Food, Void, Integer> {

    private NetworkManager networkManager;

    public DeleteFoodTask(File exceptionFileDirectory,
    ...
    protected Integer doInBackgroundInternally(Food... params) {
        serverManager.removeFood(params[0]);
        return 0;
    }
