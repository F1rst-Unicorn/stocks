...
public class FoodViewModel extends ViewModel {
    ...
    protected LiveData<List<FoodSummaryWithExpirationView>> foodByLocation;
    ...
    public LiveData<List<FoodSummaryWithExpirationView>> getCurrentFoodSubset() {
        return foodByLocation;
    }

    public LiveData<List<FoodSummaryWithExpirationView>> getFoodByLocation() {
        return foodByLocation;
    }
